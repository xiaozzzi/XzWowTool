...
HEARTH_STONE = {
  ...
  { ID = 163045, ICON = "Inv_holiday_hearthstonehallowsend", NAME = '无头骑士的炉石' },
  { ID = 165802, ICON = "Inv_holiday_hearthstonenoblegarden", NAME = '复活节的炉石' },
  { ID = 165670, ICON = "Inv_holiday_hearthstoneloveisintheair", NAME = '小匹德菲特的可爱炉石' },
  { ID = 165669, ICON = "Inv_holiday_hearthstonelunarfestival", NAME = '春节长者的炉石' },
  { ID = 166747, ICON = "Inv_holiday_hearthstonebrewfest", NAME = '美酒节狂欢者的炉石' },
  { ID = 180290, ICON = "Inv_staff_2h_ardenwealdnpc_a_01", NAME = '法夜炉石' },
  { ID = 182773, ICON = "Inv_inscription_contract_maldraxxus01", NAME = '通灵领主炉石' },
  { ID = 183716, ICON = "Inv_cape_special_revendreth_d_03", NAME = '温西尔罪碑' },
  { ID = 184353, ICON = "Ui_sigil_kyrian", NAME = '格里恩炉石' },
  { ID = 209035, ICON = "Inv_holiday_hearthstonemidsummerfirefestival", NAME = '烈焰炉石' },
  { ID = 228940, ICON = "Ui_majorfactions_web", NAME = '恶名丝线炉石' },
  { ID = 235016, ICON = "Inv_10_blacksmithing_craftedoptional_engineering_uprez", NAME = '重部署模块' },
  { ID = 236687, ICON = "Inv_111_goldenbomb_goldblue", NAME = '高爆炉石' },
  { ID = 245970, ICON = "Inv_letter_13", NAME = 'P.O.S.T.总管的特快炉石' },
  { ID = 246565, ICON = "Spell_holy_circleofrenewal_shadow", NAME = '星瀚炉石' },
  { ID = 257736, ICON = "Spell_holy_surgeoflight", NAME = '圣光呼唤炉石' },
  { ID = 263933, ICON = "Inv_enchanting_crystal_color1", NAME = '巡猎者的炉石' },
  { ID = 265100, ICON = "Inv_cosmicvoid_groundsate", NAME = '核心守卫的炉石' },
}
